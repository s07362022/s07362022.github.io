...
(function () {
  ...
  const T = {
    'page.title': { zh: '2026 香港 · Neon 旅行筆記（Immersive）', en: '2026 Hong Kong · Neon Immersive Notes' },
    'meta.description': {
      zh: '2026年8月香港3天2夜沉浸版：淺杏紙本＋霓虹、Three.js 維港、GSAP 捲動；英皇駿景、葵涌廣場、Big Bus、航班8/7–8/9',
      en: '2026 Aug Hong Kong 3D2N immersive: paper+neon, Three.js harbour, GSAP scroll; Emperor Hotel, KCP, Big Bus, Aug 7–9'
    },
